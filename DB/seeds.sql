  INSERT INTO departments (dep_name, dep_description)
    VALUES
        ("Client Support", "This is the department that takes care of all of the day to day issues our clients run into. Our clients have a direct line of contact with them."),
        ("Engineering", "Any issue that our Support team doesn't know how to handle, they talk to the engineering team about. They be kings"),
        ("C-Class", "You as CEO are part of this department. There are only a couple of members of this dept as they are the 'big bosses'."),
        ("Development", "Development is the team that creates our product. It is completely up to them to implement the new ideas that we have.")
